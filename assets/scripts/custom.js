$(document).ready(function () {
    ...
    function init_template() {//Class is vital to run AJAX Pages
        ...
        $(document).delegate('.show-left-sidebar', 'click', function (e) {
        ...
        $('.phone-pad-1').click(function () {
            var this_value = $('.phone-dial').val();
            $('.phone-dial').val(this_value + '1');
        });
        $('.phone-pad-2').click(function () {
            var this_value = $('.phone-dial').val();
            $('.phone-dial').val(this_value + '2');
        });
        $('.phone-pad-3').click(function () {
            var this_value = $('.phone-dial').val();
            $('.phone-dial').val(this_value + '3');
        });
        $('.phone-pad-4').click(function () {
            var this_value = $('.phone-dial').val();
            $('.phone-dial').val(this_value + '4');
        });
        $('.phone-pad-5').click(function () {
            var this_value = $('.phone-dial').val();
            $('.phone-dial').val(this_value + '5');
        });
        $('.phone-pad-6').click(function () {
            var this_value = $('.phone-dial').val();
            $('.phone-dial').val(this_value + '6');
        });
        $('.phone-pad-7').click(function () {
            var this_value = $('.phone-dial').val();
            $('.phone-dial').val(this_value + '7');
        });
        $('.phone-pad-8').click(function () {
            var this_value = $('.phone-dial').val();
            $('.phone-dial').val(this_value + '8');
        });
        $('.phone-pad-9').click(function () {
            var this_value = $('.phone-dial').val();
            $('.phone-dial').val(this_value + '9');
        });
        $('.phone-pad-0').click(function () {
            var this_value = $('.phone-dial').val();
            $('.phone-dial').val(this_value + '0');
        });
        $('.phone-pad-star').click(function () {
            var this_value = $('.phone-dial').val();
            $('.phone-dial').val(this_value + '*');
        });
